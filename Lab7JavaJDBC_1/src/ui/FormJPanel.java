...
// create new form Jpanel withh access to the panel passed as an argument
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(showPhotoLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 9, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(submitButton)
                .addGap(37, 37, 37))
        );
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        try {
            ...
            //        Check name validity
            if(name.isBlank()) {
                JOptionPane.showMessageDialog(this, "Invalid name provided", "errorTitle!", JOptionPane.ERROR_MESSAGE);
                return;
            }
            //        Check age validity
            if (age < 0){
            ...
            if (experience.length() <= 5 || experience.isBlank()){
                JOptionPane.showMessageDialog(this, "Invald experience provided", errorTitle, JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            JOptionPane.showMessageDialog(this, student, "Success!", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(student.getPhoto()));

            System.out.println( name +" " + age + " " + college);
            
//            Create an object of type viewJPanel
            ViewJPanel viewJPanelObject = new ViewJPanel(student);
...
//            Navigate to the next page (ViewJPanel)
            ...
            JOptionPane.showMessageDialog(this, "Invalid age provided", "Oops!", JOptionPane.ERROR_MESSAGE);
            System.out.println("Error: Invalida age provided");
        } catch (NullPointerException e) {
            JOptionPane.showMessageDialog(this, "No college selected", "Oops!", JOptionPane.ERROR_MESSAGE);
